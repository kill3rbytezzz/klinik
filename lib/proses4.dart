...
class proses4 extends StatefulWidget {
  @override
  _proses4 createState() => new _proses4();
}

class _proses4 extends State<proses4> {
  Future<void> PostStatus2() async {
    String url = "http://192.168.100.129:3000/poststatus";

    Map<String, String> headers = {'Content-Type': 'application/json'};
    Map<String, dynamic> data = {'id': reservasi_id, "status": 5};
                ...
                onPressed: () async {
                  ...
                  setState(() {
                    ...
                    Navigator.of(context).push(new MaterialPageRoute(
                        builder: (BuildContext context) => Berkas()));
                  });
                },
                child: Text(
                  "Cek Berkas",
